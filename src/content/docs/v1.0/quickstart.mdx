...
<Steps>
  ...
  4. **Customize Your Docs**
     ...
     * **Configuration**: Head over to our [Configuration Guide](/v1.0/configuration/) to learn how to update the `astro.config.mjs` file with your own logo.
     * **Use Components**: Check out the [Component Showcase](/v1.0/components/api-field/) to see how to document APIs beautifully.
