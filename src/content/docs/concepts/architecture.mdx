...
**FlightManual** is an opinionated, venture-backed documentation toolkit. It provides Mintlify-level features, automated API ingestion, and a stateful AI agent at zero cost.
